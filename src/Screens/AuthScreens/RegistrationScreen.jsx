...
const Register = () => {
    ...
    const handleFocusemeil = () => { setIsFocusedEmeil(true) }
                ...
                >
                    <View style={styles.conteiner}>
                        ...
                        <View style={styles.avatarWrapper}>
                            ...
                            >
                                <SvgAddButton
                                    style={styles.btnAddAvatarSvgLoad}
                                />
                            </TouchableOpacity>
                        </View>
                        ...
                        <Pressable>
                            <TouchableOpacity style={[styles.registerBtn]} >
                                <Text style={[styles.registerBtnText]} onPress={onRegister}>Зареєстуватися</Text>
                            </TouchableOpacity>
                        </Pressable>
